...
def Finviz():
    ...
    df.to_csv('/content/gdrive/My Drive/PPL Project/news_api-main/finviz.csv', mode='w')
...
def MoneyControlStock():
    ...
    df.to_csv('/content/gdrive/My Drive/PPL Project/news_api-main/moneycontrol.csv', mode='w')
